...
def rebal(tickerA, tickerB):
    ...
    V_Asset     = [(1/100) * x for x in range(60, 141, 10)]
    proportionA = [(1/100) * x for x in range(50, 91, 10)]
    threshold   = [(1/100) * x for x in range(1, 50)]
        ...
        for p in proportionA:
            ...
            for t in threshold:
                ...
                for i in range(1, len(dfA)):
                    ...
                    for j in range(2, 4):  # high price, low price =======================================
