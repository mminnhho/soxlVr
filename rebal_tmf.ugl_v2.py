...
#        for i in range(1, len(dfTK0)):
        for i in range(1, 21):
            for oc in [1, 4]:
                ...
                gap = abs(srTK0[oc]/priceTK0-srTK1[oc]/priceTK1)
                ...
                if gap > t:
                    ...
                    if srTK0[oc]/priceTK0 > 1:
                        quantTK0 = (bal/2/10) // srTK0[oc]
                        if balTK0 > (srTK0[oc]*quantTK0):
                            stkBalTK0 -= quantTK0
                        if balTK0 < (srTK0[oc]*quantTK0):
                            bal -= (srTK0[oc]*quantTK0)



                print(date, 
                    'tmf', f'{srTK0[oc]/priceTK0-1:7.2%}', 
                    'ugl', f'{srTK1[oc]/priceTK1-1:7.2%}',
                    'gap', f'{gap:7.2%}')
